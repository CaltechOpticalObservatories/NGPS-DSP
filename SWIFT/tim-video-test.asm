...
NSR     DC      512             ; Number Serial Read, prescan + image + bias
...
NSERIALS_READ	DC	200	      ; Number of serials to read

; Waveform parameters
OS		DC	'_U2'	; Output source 
...
SERIAL_READ     DC      SERIAL_READ_RIGHT  ;14  ; Serial readout waveforms
SERIAL_SKIP 	DC	SERIAL_SKIP_RIGHT  ;15	; Serial skipping waveforms
PARALLEL        DC      PARALLEL_1         ;16  ; Parallel shifting waveforms
PARALLEL_CLEAR  DC      PARALLEL_CLEAR_1   ;17
PC_1            DC      PARALLEL_CLEAR_1   ;18
PC_2            DC      PARALLEL_CLEAR_2   ;19
SERIAL_IDLE     DC      SERIAL_IDLE_LEFT   ;20
